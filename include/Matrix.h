...
// Computations
  ...
  static const Matrix Pauli0(){return Matrix(Vector(0, 0, 0), Vector(0, 0, -1), Vector(0, 1, 0));}
  static const Matrix Pauli1(){return Matrix(Vector(0, 0, 1), Vector(0, 0, 0), Vector(-1, 0, 0));}
  static const Matrix Pauli2(){return Matrix(Vector(0, -1, 0), Vector(1, 0, 0), Vector(0, 0, 0));}

  static const Matrix unitMatrix(){return Matrix(Vector(1, 0, 0), Vector(0, 1, 0), Vector(0, 0, 1));}
  static const Matrix outerProduct(const Vector a, const Vector b);
  const Vector vecMultMat(const Vector&) const;
